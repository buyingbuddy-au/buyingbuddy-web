...
function DealLandingPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl overflow-x-clip px-4 pb-12 pt-6 sm:px-6 lg:px-8 lg:pt-12">
      <section className="grid min-w-0 gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] lg:items-start">
        ...
        {/* Right — create form */}
        <div className="min-w-0 rounded-[2rem] border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <form onSubmit={handleCreateDeal} className="mt-6 grid gap-4">
            <label className="grid min-w-0 gap-2" htmlFor="deal-email">
              ...
              <input
                ...
                className="w-full min-w-0 rounded-2xl border border-gray-300 bg-white px-4 py-4 text-base text-gray-900 outline-none transition focus:border-teal-600 focus:ring-4 focus:ring-teal-600/10 sm:text-sm"
              />
            </label>

            <label className="grid min-w-0 gap-2" htmlFor="deal-rego">
              ...
              <input
                ...
                placeholder="123ABC"
                className="w-full min-w-0 rounded-2xl border border-gray-300 bg-white px-4 py-4 font-mono text-base uppercase text-gray-900 outline-none transition focus:border-teal-600 focus:ring-4 focus:ring-teal-600/10 sm:text-sm"
              />
            </label>
