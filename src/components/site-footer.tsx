...
export default function SiteFooter() {
  return (
    <footer className="border-t border-gray-200 bg-white">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 pb-[calc(2rem+5rem+env(safe-area-inset-bottom))] pt-8 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:pb-8">
        ...
        <div className="flex flex-col gap-3 border-t border-gray-100 pt-5 text-sm text-gray-500 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            ...
            <Link href="/deal" className="font-semibold text-gray-700 transition hover:text-teal-600">
              Deal Room
            </Link>
