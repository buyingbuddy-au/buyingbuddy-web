...
const MODES = [
  {
    ...
    subtitle: "Interactive 20-point flow",
    ...
    badge: "Recommended",
    features: ["20 guided checkpoints", "Notes per item", "Risk rating at the end", "Sharable results", "Takes 10-15 minutes"],
  },
  {
    href: "/inspect/print",
    icon: ClipboardCheck,
    ...
    badge: null,
    features: ["One-page printable PDF", "20 key checks", "Works offline once printed", "Takes 5 minutes", "Share or save as PDF"],
  },
] as const;
        ...
        {MODES.map((mode) => {
          ...
          return (
            <Link
              key={mode.href}
              href={mode.href}
              className="group relative flex flex-col rounded-[2rem] border border-gray-200 bg-white p-6 shadow-sm transition hover:border-teal-300 hover:shadow-md sm:p-8"
            >
              {mode.badge && (
